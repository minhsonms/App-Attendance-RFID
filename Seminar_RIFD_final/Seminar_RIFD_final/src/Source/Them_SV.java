 ...
 * @author ADMIN
 */
public class Them_SV extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Them_SV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void event() {
        ...
        savebtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(dao.getStudentById(id.getText()) != null){
                    JOptionPane.showMessageDialog(null, "ID đã được sử dụng vui lòng chọn ID khác");
                    return;
                }
                
                 if(dao.getStudentFromEPC(epc.getText()) != null){
                    JOptionPane.showMessageDialog(null, "EPC đã được sử dụng vui lòng chọn EPC khác");
                    return;
                }
